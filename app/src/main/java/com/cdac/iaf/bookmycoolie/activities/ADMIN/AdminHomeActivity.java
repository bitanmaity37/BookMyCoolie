...
public class AdminHomeActivity extends AppCompatActivity {
    ...
    MaterialCardView btn_addopt, listops;
    ...
    private void showPopupMenuOperator(View view) {
        PopupMenu popupMenu = new PopupMenu(AdminHomeActivity.this, view);
        popupMenu.getMenuInflater().inflate(R.menu.popup_menu_admin_for_oprtr, popupMenu.getMenu());
